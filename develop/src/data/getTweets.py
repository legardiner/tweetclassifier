...
parser.add_argument('--screen_name',
                    ...
                    help='Screen name to scrape tweets')
parser.add_argument('--output_path',
                    default='../../data/interim',
                    help='Path to directory to store tweets')


def create_API_access():
    """This function creates a twitter API access point.

    Requirements: `CONSUMER_KEY`, `CONSUMER_SECRET`, `ACCESS_TOKEN`, and
    `ACCESS_SECRET` must be created at https://apps.twitter.com/. Credentials
    should be stored in a `.env` file in your root directory.
...
def clean_string(tweet):
    """This function takes the text from a tweet and preproceses it.
...
def get_user_tweets(api, screen_name, output_path):
    """This function pulls and cleans tweets for a specified username
